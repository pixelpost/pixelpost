...
SVN file version:
$Id: admin-lang-romanian.php 450 2007-10-22 00:00:42Z david.kozikowski $
...
$_lang_file_translator        					= 'Alex Mielus - adminul este partial tradus';
$_lang_file_email             					= 'alex@mielus.ro';
$_lang_file_rev               					= '1.7';

$admin_lang_isrtl             					= "nu"; // yes for right-to-left languages and no for left-to-right languages
$admin_lang_update            					= "Schimba";
$admin_lang_reload            					= "<br /> E posibil sa trebuiasca sa reincarci pagina pentru a vedea schimbarile.";
$admin_lang_error             					= "Eroare";
$admin_lang_post              					= "posts";
$admin_lang_page              					= "pagina";
$admin_lang_of                					= "of";
$admin_lang_next              					= "Urmator";
$admin_lang_prev              					= "Anterior";
$admin_lang_show              					= "Arata";
$admin_lang_go                					= "Gata!";
$admin_lang_done              					= "Gata:";
$admin_lang_example								= "Exemplu";


// Admin Start
$admin_start_1                					= "Nu exista folderul <b>language</b> sau fisierul";
$admin_start_2                					= "nu exista in acel director.\n<br />Asigura-te ca ai uploadat toate fisierele necesare avand aceleasi denumiri specificate aici.";
$admin_start_userpw           					= "Nume de utilizator sau parola incorecte.";
$admin_start_pw_forgot        					= "Ai uitat parola?";
$admin_start_browser_title    					= "ADMIN";
$admin_start_welcome          					= "Bine ai venit la panoul de administrare al Pixelpost - trebuie sa te autentifici.";
$admin_start_pp_name          					= "Link catre blogul tau foto bazat pe Pixelpost:";
$admin_start_pp_tit           					= "apasa aici pentru a incarca blogul tau foto";
$admin_start_cookie           					= "Cand te autentifici este setat un cookie";
$admin_start_username         					= "Nume de utilizator";
$admin_start_pw               					= "Parola";
$admin_start_pw_button        					= "Trimite-mi noua parola";
$admin_start_pw_recover       					= "Nu exista <span style='color:red;'><b>nici o cale pentru a recupera vechea ta parola</b></span> dar Pixelpost poate genera 
                                 				o noua parola pentru tine.\n<br />
                                 				Te rog sa scrii adresa de email pe care ai salvat-o in panoul de administrare.
                                 				<br />Vei primi imediat o noua parola prin email.";
$admin_start_email            					= "Adresa de email:";
$admin_start_email_button     					= "Scrie adresa ta de email";
$admin_start_admin_1          					= "Administrare";
$admin_start_admin_2          					= "pentru";
$admin_start_remember         					= "Autentifica-ma automat la fiecare vizita:";

// Password Recovery

// Front Page
$admin_lang_pw_title            				= "Recuperarea parolei";

$admin_lang_pw_wronguser        				= "Numele de utilizator folosit nu corespunde numelui de utilizator al adminului.";
$admin_lang_pw_back             				=  "Inapoi la pagina de administrare";
$admin_lang_pw_noemail          				= "Nu ai scris nici o adresa de email! \n<br />
                                   				Daca nu stii nimic despre parola ta, te rog sa lasi un mesaj pe <a href='http://forum.pixelpost.org/'>forumul Pixelpost</a> pentru ajutor.\n<br />";
$admin_lang_pw_notsent          				= "Nu am trimis nimic! \n<br /> Adresa de email pe care ai scris-o nu este adresa de email salvata in panoul de administrare.<br />";
$admin_lang_pw_subject          				= "Mesaj pentru recuperarea parolei";
$admin_lang_pw_usertext         				= "Numele tau de utilizator:";
$admin_lang_pw_mailtext         				= "Adresa ta de email:";
$admin_lang_pw_newpw            				= "Noua ta parola:";
$admin_lang_pw_text_1           				= "Aceasta este recuperarea parolei de la Pixelpost";
$admin_lang_pw_text_2           				= "De la: Sectiunea de administrare a Pixelpost";
$admin_lang_pw_text_3           				= "Un email a fost trimis catre adresa ta de email. El contine numele de utilizator si parola. \n<br />  Verifica adresa de email la ";
$admin_lang_pw_text_4           				= "<span style='color:red;'>Eroare! S-a intamplat ceva! \n<br />Adresa de email si numele de utilizator pe care le-ai scris sunt OK, dar nu am putut trimite emailul!! \n<br />Cere ajutor de la administratorul serverului tau.</span>";
$admin_lang_pw_text_5           				= "Eroare a bazei de date:";
$admin_lang_pw_text_6           				= "<br />Nu am putut schimba noua parola.";
$admin_lang_pw_text_7           				= "Acest email este trimis automat din partea formularului de autentificare a blogului tau foto.\n Cineva a cerut o noua parola pentru sectiunea de administrare.\n\nAr trebui sa te autentifici imediat in sectiunea de administrare\n\nat ";
$admin_lang_pw_text_8           				= "\n\nutilizand noua parola pentru a reseta aceasta parola creata automat!\n\n";

// Admin Menu
$admin_lang_new_image          					= "Imagine noua";
$admin_lang_images             					= "Imagini";
$admin_lang_categories         					= "Categorii";
$admin_lang_comments           					= "Comentarii";
$admin_lang_options            					= "Optiuni";
$admin_lang_general_info       					= "Informatii generale";
$admin_lang_addons             					= "Addons";
$admin_lang_logout             					= "Iesire";

// New Image
$admin_lang_ni_post_a_new_image   				= "Publica o noua imagine";
$admin_lang_ni_image              				= "Imagine";
$admin_lang_ni_image_title        				= "Titlul imaginii";
$admin_lang_ni_select_cat         				= "Selecteaza categoriile / cuvintele cheie";
$admin_lang_ni_description        				= "Descrierea / textul imaginii";
$admin_lang_ni_datetime           				= "Data si ora";
$admin_lang_ni_post_now           				= "Publica acum";
$admin_lang_ni_post_one_day_after 				= "Publica dupa o zi de la ultimul post";
$admin_lang_ni_post_spec_date     				= "Publica intr-o zi specifica. Te rog sa setezi data de mai sus:";
$admin_lang_ni_post_entry         				= "Publica imaginea";
$admin_lang_ni_upload             				= "Incarca";
$admin_lang_ni_upload_error       				= "E ceva gresit in Incarcarea fisierului!";
$admin_lang_ni_posted             				= "INCARCATA";
$admin_lang_ni_year               				= "an";
$admin_lang_ni_month              				= "luna";
$admin_lang_ni_day                				= "zi";
$admin_lang_ni_hour               				= "ora";
$admin_lang_ni_min                				= "minut";
$admin_lang_ni_markdown_text      				= "Foloseste Markdown sau HTML pentru a formata textul din acest camp.";
$admin_lang_ni_markdown_hp        				= "Markdown-ul paginii de start";
